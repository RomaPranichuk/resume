                    ...
                    projects: [
                        {
                            ...
                            about: 'Airbnb competitor. High-load application for searching apertments',
    ...
    res.render('shoporder', {
        ...
        quiz: {
            ...
            factors: {
                ...
                options: ['Ціна', 'Репутація бренду', 'Якість', 'Особливості', 'Гарантія', 'Доступність', 'Обслуговування клієнтів'],
            },
        },
        footer: [
            [
    ...
    res.render('shopreview', {
        ...
        filterBlock: {
            ...
            filterList: [
                ...
                {
                    title: 'Процесор',
                    options: [{ value: 'Intel Core i7' }, { value: 'Intel Core i5' }, { value: 'Intel Core i3' }, { value: 'AMD Ryzen 9' }],
                },
                {
                ...
                },
                {
                    ...
                    options: [{ value: '10 - 12ГБ' }, { value: '16 - 24ГБ' }, { value: '32ГБ і більше' }, { value: '4ГБ' }, { value: '6 - 8ГБ' }],
                },
                {
                    title: 'Операційна система',
                    options: [{ value: 'Chrome OS' }, { value: 'Linux' }, { value: 'Windows' }, { value: 'Mac OS' }, { value: 'Без ОС' }],
                },
            ],
        },
        goodsList: [
